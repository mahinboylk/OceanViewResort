...
<%
    ...
    /* ── Pull servlet attributes (set by ReportsServlet via ReportsService) ── */
    ...
    if (revenueByRoomType != null && !revenueByRoomType.isEmpty()) {
        for (Map.Entry<String, Double> entry : revenueByRoomType.entrySet()) {
            ...
            revRows.append("<td><div class='prog-wrap'><div class='prog-bar' style='width:").append(String.format("%.1f", pct)).append("%;'></div></div>");
            revRows.append("<span style='font-size:0.75rem;color:var(--mist);margin-left:6px;'>").append(String.format("%.1f", pct)).append("%</span></td>");
            revRows.append("</tr>");
        }
    } else {
...
<head>
    ...
    <%-- NO inline <style> block — all styling comes from style.css --%>
...
<div class="page-content">
    <div class="inner-shell">
        <div class="content-col">
            ...
            <div class="stat-strip" style="grid-template-columns:repeat(5,1fr);">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-c">
                        ...
                        <span class="stat-val" style="font-size:1.2rem;">Rs. <%= totalRevStr %></span>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-c">
                        <span class="stat-lbl">Current Occupancy</span>
                        <span class="stat-val"><%= occupancyStr %>%</span>
                        <span class="stat-sub"><%= currentOccupancy %> rooms now</span>
                    </div>
                    <i class="fas fa-hotel stat-ico"></i>
                </div>

                <div class="stat-card">
                    <div class="stat-bg" style="background-image:url('https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&q=75');"></div>
                    <div class="stat-c">
            ...
            <!-- Reservation Status Summary — uses system .status-grid / .status-tile classes -->
            <div class="panel">
            ...
            <!-- Revenue by Room Type — uses system .prog-wrap / .prog-bar classes -->
            <div class="panel">
